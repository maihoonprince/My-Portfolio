...
import { Mongodb, Nodejs, myProfile, Reactjs, Nextjs } from "../assets";
    ...
    <div className="w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 2xl:gap-20 py-20">
      <div className='flex flex-col mb-20 lg:mb-0'
        ...
        <div className='mt-10 flex gap-10'>
          <a href='https://drive.google.com/file/d/1qxAm81iZ3CjZMAZfSu-ncIG1rd1j9kHC/view?usp=drivesdk' target='_blank' rel='noopener noreferrer'>
      ...
      <div className='w-full flex-1 flex justify-center'>
        <div className='w-[300px] h-[290px] md:w-[400px] md:h-[400px] 2xl:w-[500px] 2xl:h-[500px]  border rounded-full border-gray-600 dark:border-gray-200 relative  md:mt-20 lg:mt-0 flex items-center justify-center'>
          <img
            src={myProfile}
            className='w-4/5 h-auto absolute top-700 md:top-15 border rounded-full '
            data-aos='fade-down'
            data-aos-offset='200'
            data-aos-delay='50'
