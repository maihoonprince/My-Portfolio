    ...
    <footer>
      ...
      <div className='flex flex-col gap-10 items-center justify-center pb-20 '>
        ...
        <div className='flex gap-10 text-white text-2xl mb-10'>
          <a href='https://github.com/maihoonprince' target='_blank' rel='noopener noreferrer'>
            <FaGithub className='hover:scale-125' />
          </a>

          <a href='https://www.linkedin.com/in/prinx/' target='_blank' rel='noopener noreferrer'>
            <BsLinkedin className='hover:scale-110' />
          </a>

          <a href='https://twitter.com/maihoonprinx' target='_blank' rel='noopener noreferrer'>
